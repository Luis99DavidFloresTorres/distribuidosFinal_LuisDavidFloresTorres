...
import static com.example.jwt.security.Constantes.AUTH_HEADER_NAME;
import static com.example.jwt.security.Constantes.TOKEN_PREFIX;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            ...
            username = (String) data.get("usuario");
     ...
     */
    @Override
    //authentication representa el token de la autenticacion en java
    ...
    private void writeSessionData(HttpServletResponse response, AppUserDetails userDetails, String token, long expiration) throws IOException {
        ...
        jsonMap.put("name", userDetails.getUsername());
        jsonMap.put("rol", userDetails.getRol());
    ...
    private String createToken(AppUserDetails userDetails, long accessTokenValiditySeconds) {
        ...
        extra.put("rol", userDetails.getRol());
